...
class Blockchain {
    ...
    isChainValid() {
        for (let i=1; i < this.chain.length; i++) {
            ...
            console.log("block", i, "transactions valid:", currentBlock.transactionsValid());
            if (!currentBlock.transactionsValid()) {
            ...
            if (currentBlock.previousHash !== this.chain[i-1].hash) {
